...
(function () {
  ...
  // Tailwind configuration now lives in tailwind.config.cjs and is baked
  // into /styles.css at build time. Theme tokens still resolve via CSS
  // variables (declared in step 2 above), so dark mode keeps working.
